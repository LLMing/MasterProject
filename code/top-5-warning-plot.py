...
for fn in fileName:
    ...
    i, j, k, o, p = 0,0,0,0,0
    for item in csvFile:
        if item[0] == "WCAG2AAA.Principle1.Guideline1_4.1_4_6.G17.BgImage" and item[2] != "notice" and item[2] != "error":
            i += 1
        if item[0] == "WCAG2AAA.Principle3.Guideline3_2.3_2_5.H83.3" and item[2] != "notice" and item[2] != "error":
            j += 1
        if item[0] == "WCAG2AAA.Principle1.Guideline1_4.1_4_3_F24.F24.FGColour" and item[2] != "notice" and item[2] != "error":
            k += 1
        if item[0] == "WCAG2AAA.Principle1.Guideline1_3.1_3_1.H42" and item[2] != "notice" and item[2] != "error":
            o += 1
        if item[0] == "WCAG2AAA.Principle1.Guideline1_3.1_3_1.H48" and item[2] != "notice" and item[2] != "error":
            p += 1
    top_1.append(i)
    top_2.append(j)
    top_3.append(k)
...
labels = ["G17.BgImage", "H83.3", "F24.FGColour", "H42", "H48"]
plt.boxplot([top_1, top_2, top_3, top_4, top_5],labels=labels,showfliers=True,sym="o")
plt.show()
